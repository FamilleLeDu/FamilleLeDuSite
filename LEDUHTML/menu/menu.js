...
oM.makeMenu('m15','m4','Liste des actes à rechercher','../etats/actesarechercher0.htm','',200,0);
oM.makeMenu('m17','m4','Statistiques','../etats/stats.htm','',200,0);
oM.makeMenu('m5','','Arbre 3D','../dswmedia/arbre3D.htm');
oM.makeMenu('m6','','Mes liens','');oM.makeMenu('m21','m6','Retour Site Famille Le Du','http://familleledu.free.fr/acceuil/acceuil.html','_blank',200,0);

var avail="40+((cmpage.x2-45)/6)";
oM.menuPlacement=new Array(42,avail+"-11",avail+"*2-8",avail+"*3-12",avail+"*4-7",avail+"*5-9");
oM.construct();
